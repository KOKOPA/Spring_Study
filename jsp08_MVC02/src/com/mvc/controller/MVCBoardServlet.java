...
@WebServlet(urlPatterns = {"/selectall", "/selectone", "/insertform", "/insertres", "/updateform", "/updateres", "/deleteone"})
public class MVCBoardServlet extends HttpServlet {
	...
	private void doDeleteOne(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if(res > 0) {
			...
			out.println("location.href='selectall'; </script>");
		} else {
			out.println("<script> alert('삭제 실패');");
			out.println("location.href='selectone?seq=" + seq + "';</script>");
		}
	}
	...
	private void doInsertRes(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		if(res > 0) {
			...
			out.println("location.href='insertform'; </script>");
		}
		
	}

	private void doInsertForm(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
